...
scripts/ download_data.py calculate_scores.py run_backtest.py generate_report.py
data/   raw/ processed/ cache/        output/ scores/ holdings/ performance/ charts/ report/     tests/
```
